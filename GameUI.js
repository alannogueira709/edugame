...
const ICON_ARROWS = `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/></svg>`;
...
export class GameUI {
    ...
    // ──────────────────────────────────────────────────────────
    //  ATUALIZACAO — chamada a cada frame
    // ──────────────────────────────────────────────────────────
    ...
    /**
     * Exibe o modal de resultado apos uma parada.
    ...
    _hudTemplate() {
        ...
        <div class="game-statusbar">
            <span class="status-icon" aria-hidden="true">${ICON_ARROWS}</span>
